...
export const ServiceCarousel = () => {
  ...
  return (
    <Row className="w-100 m-auto">
      ...
      >
        <div value="Anootation" onClick={() => handleClick("Anootation")}>
          <img src={box} alt="Anootation" className={"tabIcon pr-2"} />
          Anootation
        </div>
        <div
          className="d-flex"
        ...
        >
          <img src={cuboid} alt="Data Generation" className={"tabIcon pr-2"} />
          Data Generation
        </div>
        <div className="d-flex" value="AI" onClick={() => handleClick("AI")}>
